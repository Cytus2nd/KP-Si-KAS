            ...
            <div class="row">
                ...
                <table class="table table-bordered table-light table-striped" id="tabel">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?= htmlspecialchars($pmr['jumlah']); ?></td>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-success mb-1" data-bs-toggle="modal" data-bs-target="#modalUbah<?= $pmr['id_user']; ?>">Ubah</button>
                                <button type="button" class="btn btn-danger mb-1" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $pmr['id_user']; ?>">Hapus</button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        <?php endif; ?>
