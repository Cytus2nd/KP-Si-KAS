...
$universal_pemasukan_osis = $universal_pengeluaran_osis = $universal_total_kas_osis = 0;
$universal_pemasukan_pramuka = $universal_pengeluaran_pramuka = $universal_total_kas_pramuka = 0;
$universal_pemasukan_pmr = $universal_pengeluaran_pmr = $universal_total_kas_pmr = 0;
$universal_pemasukan_kkr = $universal_pengeluaran_kkr = $universal_total_kas_kkr = 0;
...
if ($jabatan == 1 || $jabatan == 2 || $jabatan == 3) {
    ...
    // Fetch OSIS universal data
    $query_universal_osis_pemasukan = "SELECT SUM(jumlah) as total_pemasukan FROM kas_osis WHERE tipe_kas='pemasukan'";
    $stmt_universal_osis_pemasukan = $conn->prepare($query_universal_osis_pemasukan);
    $stmt_universal_osis_pemasukan->execute();
    $result_universal_osis_pemasukan = $stmt_universal_osis_pemasukan->get_result();
    $data_universal_osis_pemasukan = $result_universal_osis_pemasukan->fetch_assoc();
    $universal_pemasukan_osis = $data_universal_osis_pemasukan['total_pemasukan'] ?? 0;

    $query_universal_osis_pengeluaran = "SELECT SUM(jumlah) as total_pengeluaran FROM kas_osis WHERE tipe_kas='pengeluaran'";
    $stmt_universal_osis_pengeluaran = $conn->prepare($query_universal_osis_pengeluaran);
    $stmt_universal_osis_pengeluaran->execute();
    $result_universal_osis_pengeluaran = $stmt_universal_osis_pengeluaran->get_result();
    $data_universal_osis_pengeluaran = $result_universal_osis_pengeluaran->fetch_assoc();
    $universal_pengeluaran_osis = $data_universal_osis_pengeluaran['total_pengeluaran'] ?? 0;

    $universal_total_kas_osis = $universal_pemasukan_osis - $universal_pengeluaran_osis;
}

if ($jabatan == 1 || $jabatan == 2 || $jabatan == 4) {
    // Fetch Pramuka monthly data
    ...
    // Fetch Pramuka universal data
    $query_universal_pramuka_pemasukan = "SELECT SUM(jumlah) as total_pemasukan FROM kas_pramuka WHERE tipe_kas='pemasukan'";
    $stmt_universal_pramuka_pemasukan = $conn->prepare($query_universal_pramuka_pemasukan);
    $stmt_universal_pramuka_pemasukan->execute();
    $result_universal_pramuka_pemasukan = $stmt_universal_pramuka_pemasukan->get_result();
    $data_universal_pramuka_pemasukan = $result_universal_pramuka_pemasukan->fetch_assoc();
    $universal_pemasukan_pramuka = $data_universal_pramuka_pemasukan['total_pemasukan'] ?? 0;

    $query_universal_pramuka_pengeluaran = "SELECT SUM(jumlah) as total_pengeluaran FROM kas_pramuka WHERE tipe_kas='pengeluaran'";
    $stmt_universal_pramuka_pengeluaran = $conn->prepare($query_universal_pramuka_pengeluaran);
    $stmt_universal_pramuka_pengeluaran->execute();
    $result_universal_pramuka_pengeluaran = $stmt_universal_pramuka_pengeluaran->get_result();
    $data_universal_pramuka_pengeluaran = $result_universal_pramuka_pengeluaran->fetch_assoc();
    $universal_pengeluaran_pramuka = $data_universal_pramuka_pengeluaran['total_pengeluaran'] ?? 0;

    $universal_total_kas_pramuka = $universal_pemasukan_pramuka - $universal_pengeluaran_pramuka;
}

if ($jabatan == 1 || $jabatan == 2 || $jabatan == 5) {
    // Fetch PMR monthly data
    ...
    // Fetch PMR universal data
    $query_universal_pmr_pemasukan = "SELECT SUM(jumlah) as total_pemasukan FROM kas_pmr WHERE tipe_kas='pemasukan'";
    $stmt_universal_pmr_pemasukan = $conn->prepare($query_universal_pmr_pemasukan);
    $stmt_universal_pmr_pemasukan->execute();
    $result_universal_pmr_pemasukan = $stmt_universal_pmr_pemasukan->get_result();
    $data_universal_pmr_pemasukan = $result_universal_pmr_pemasukan->fetch_assoc();
    $universal_pemasukan_pmr = $data_universal_pmr_pemasukan['total_pemasukan'] ?? 0;

    $query_universal_pmr_pengeluaran = "SELECT SUM(jumlah) as total_pengeluaran FROM kas_pmr WHERE tipe_kas='pengeluaran'";
    $stmt_universal_pmr_pengeluaran = $conn->prepare($query_universal_pmr_pengeluaran);
    $stmt_universal_pmr_pengeluaran->execute();
    $result_universal_pmr_pengeluaran = $stmt_universal_pmr_pengeluaran->get_result();
    $data_universal_pmr_pengeluaran = $result_universal_pmr_pengeluaran->fetch_assoc();
    $universal_pengeluaran_pmr = $data_universal_pmr_pengeluaran['total_pengeluaran'] ?? 0;

    $universal_total_kas_pmr = $universal_pemasukan_pmr - $universal_pengeluaran_pmr;
}

if ($jabatan == 1 || $jabatan == 2 || $jabatan == 6) {
    // Fetch KKR monthly data
    ...
    // Fetch KKR universal data
    $query_universal_kkr_pemasukan = "SELECT SUM(jumlah) as total_pemasukan FROM kas_kkr WHERE tipe_kas='pemasukan'";
    $stmt_universal_kkr_pemasukan = $conn->prepare($query_universal_kkr_pemasukan);
    $stmt_universal_kkr_pemasukan->execute();
    $result_universal_kkr_pemasukan = $stmt_universal_kkr_pemasukan->get_result();
    $data_universal_kkr_pemasukan = $result_universal_kkr_pemasukan->fetch_assoc();
    $universal_pemasukan_kkr = $data_universal_kkr_pemasukan['total_pemasukan'] ?? 0;

    $query_universal_kkr_pengeluaran = "SELECT SUM(jumlah) as total_pengeluaran FROM kas_kkr WHERE tipe_kas='pengeluaran'";
    $stmt_universal_kkr_pengeluaran = $conn->prepare($query_universal_kkr_pengeluaran);
    $stmt_universal_kkr_pengeluaran->execute();
    $result_universal_kkr_pengeluaran = $stmt_universal_kkr_pengeluaran->get_result();
    $data_universal_kkr_pengeluaran = $result_universal_kkr_pengeluaran->fetch_assoc();
    $universal_pengeluaran_kkr = $data_universal_kkr_pengeluaran['total_pengeluaran'] ?? 0;
